...
class ExperienceViewController: UIViewController {
    ...
    func initMainCollectionView() {
        ...
        mainCollectionView.register(ExperienceCell.self, forCellWithReuseIdentifier: "ExperienceCell")
    }
    
    func setNavBar() {
        navigationController?.isNavigationBarHidden = false
        navigationItem.title = "체험완료한 기업"
...
extension ExperienceViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ExperienceCell", for: indexPath) as? ExperienceCell
        else {
