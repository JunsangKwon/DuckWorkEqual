//
//  ScrapEnterpriseViewController.swift
//  DuckWorkEqual
//
...
class ScrapEnterpriseViewController: UIViewController {
    ...
    func initMainCollectionView() {
        ...
        mainCollectionView.register(ScrapCell.self, forCellWithReuseIdentifier: "ScrapCell")
    }
    
    func setNavBar() {
        navigationController?.isNavigationBarHidden = false
        navigationItem.title = "스크랩한 기업"
...
extension ScrapEnterpriseViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ScrapCell", for: indexPath) as? ScrapCell
        else {
