...
class EnterpriseCell: UICollectionViewCell {
    ...
    let volunteerButton = UIButton().then {
    ...
    private func setViewHierarchy() {
        ...
        containerView.addSubviews(enterpriceNameLabel, titleLabel, hashTagLabel, logoImageView, lineView, starLabel, starButton1, starButton2, starButton3, starButton4, scrapButton, scrapLabel, volunteerButton)
    }
    ...
    private func setConstraints() {
        ...
        scrapButton.snp.makeConstraints {
            $0.centerY.equalTo(starLabel)
            $0.trailing.equalTo(scrapLabel.snp.leading).offset(-5)
        }

        scrapLabel.snp.makeConstraints {
            $0.centerY.equalTo(starLabel)
            $0.trailing.equalTo(volunteerButton.snp.leading).offset(-20)
        }

        volunteerButton.snp.makeConstraints {
            $0.centerY.equalTo(starLabel)
            $0.trailing.equalToSuperview().offset(-20)
        }
    }
