...
class ExperienceCell: UICollectionViewCell {
    ...
    private func setViewHierarchy() {
        ...
        containerView.addSubviews(enterpriceNameLabel, titleLabel, hashTagLabel, logoImageView, lineView, starLabel, starButton1, starButton2, starButton3, starButton4, reviewButton)
    }
